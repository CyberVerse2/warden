...
export function FeedRow({ r }: { r: ReceiptRow }) {
  return (
    <div className="grid min-w-[680px] grid-cols-[78px_22px_140px_1fr_88px_72px] items-center gap-4 py-2 px-1 border-b border-hairline/60 hover:bg-bg-row/40 transition-colors text-[12.5px] group">
